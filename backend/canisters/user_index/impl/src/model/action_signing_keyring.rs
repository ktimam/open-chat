...
impl ActionSigningKeyring {
    pub fn ensure_initialized(&mut self, rng: &mut impl CryptoRng, now: TimestampMillis) -> Result<bool, String> {
...
fn generate_action_signing_key(rng: &mut impl CryptoRng) -> Result<(String, SecretKeyDer), String> {
